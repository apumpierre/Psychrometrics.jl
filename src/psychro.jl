...
function psychro(;
    ...
    elseif !isnan(Tdew) && !isnan(W)
        ...
        tdew = dewTemp(pw)
        error(string(
                "Dew point temperature and humidity are not independent variables.\n",
                W, " kg/kg humidity corresponds to ", tdew, " K dew point temperature.\n",
                Tdew, " K dew point temperature corresponds to ", w, " kg/kg humidity.\n"
            ))
